  ...
  return (
    <CaseLayout
      ...
      deliverables={[
        ...
        "AI insight generation with trend detection",
        "Class/utilization analysis via predictive modeling",
        "High-frequency refresh with offline caching",
      ]}
      impact={[
        "85% faster reporting",
        "Improved retention via AI churn prediction",
        "Single executive view for better decisions",
      ]}
